(() => {
  ...
  var testimonialGroupCon = document.querySelector("#testimonial-group");
  ...
  // assets/js/modules/date-format.js
  var import_moment = __toESM(require_moment());
  jQuery(document).ready(($) => {
    $("#date").on("change", function() {
      const datePicked = (0, import_moment.default)(this.value);
  ...
  // assets/js/modules/animation-scroll.js
